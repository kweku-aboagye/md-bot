...
const OPT_IN_BODY =
  "[MD Bot] You're now opted in to SMS reminders from Kweku Aboagye / Church Music Dept. Msg frequency ~2-6/mo. Msg&Data rates may apply. Reply STOP to cancel, HELP for help.";
